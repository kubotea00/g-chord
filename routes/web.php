...
Route::post('/myscore/{user_id}/{my_score_title_id}', 'MyScoreCommentController@store');
Route::get('/myscore/{user_id}/{my_score_title_id}', 'MyScoreLyricController@show');
Route::delete('/artists/{artist_id}/{song_title_id}/{post_id}', 'PostController@destroy');
Route::delete('/myscore/{user_id}/{my_score_title_id}/{my_score_comment_id}', 'MyScoreCommentController@destroy');